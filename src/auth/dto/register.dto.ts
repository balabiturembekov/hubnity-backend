import { IsEmail, IsString, MinLength, MaxLength, IsOptional, IsNumber, Min, Max, IsUrl, Matches } from 'class-validator';
...
export class RegisterDto {
  ...
  @ApiProperty({
    description: 'Подтверждение пароля (Confirm password) - должно совпадать с паролем',
    example: 'password123',
    minLength: 8,
    maxLength: 128,
    format: 'password',
