...
export class ProjectsController {
  ...
  @ApiOperation({ 
    ...
    description: 'Создает новый проект в компании. Доступно только для OWNER и ADMIN.',
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Обновляет информацию о проекте. Доступно только для OWNER и ADMIN.',
  })
  @ApiParam({ name: 'id', description: 'ID проекта', type: String })
  ...
  @ApiOperation({ 
    ...
    description: 'Удаляет проект из компании. Доступно только для OWNER и ADMIN.',
  })
  @ApiParam({ name: 'id', description: 'ID проекта', type: String })
