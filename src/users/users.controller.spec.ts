...
describe('UsersController', () => {
  ...
  describe('create', () => {
    ...
    it('should create a user', async () => {
      ...
      expect(usersService.create).toHaveBeenCalledWith(createUserDto, mockOwner.companyId, mockOwner.role);
    });
  });
  ...
  describe('getMyProfile', () => {
    it('should return current user profile', async () => {
      ...
      expect(result).toEqual(mockUser);
      expect(usersService.findOne).toHaveBeenCalledWith(mockUser.id, mockUser.companyId);
    });
  });
  ...
  describe('updateMyProfile', () => {
    ...
    it('should update current user profile', async () => {
      ...
      expect(usersService.update).toHaveBeenCalledWith(mockUser.id, updateUserDto, mockUser.companyId, mockUser.role);
    });
  ...
  describe('findOne', () => {
    it('should return user if owner', async () => {
      ...
      expect(result).toEqual(mockUser);
      expect(usersService.findOne).toHaveBeenCalledWith(mockUser.id, mockOwner.companyId);
    });
    ...
    it('should return user if admin', async () => {
      ...
      expect(result).toEqual(mockUser);
      expect(usersService.findOne).toHaveBeenCalledWith(mockUser.id, mockAdmin.companyId);
    });
    ...
    it('should throw ForbiddenException if employee tries to view other profile', () => {
      ...
      expect(() => controller.findOne(otherUserId, employeeUser)).toThrow(ForbiddenException);
  ...
  describe('update', () => {
    ...
    it('should update user', async () => {
      ...
      const result = await controller.update(mockUser.id, updateUserDto, mockOwner);

      expect(result).toEqual(updatedUser);
      expect(usersService.update).toHaveBeenCalledWith(mockUser.id, updateUserDto, mockOwner.companyId, mockOwner.role, mockOwner.id);
    });
  });
  ...
  describe('remove', () => {
    it('should delete user', async () => {
      ...
      expect(result).toEqual(mockUser);
      expect(usersService.remove).toHaveBeenCalledWith(mockUser.id, mockOwner.companyId, mockOwner.role, mockOwner.id);
    });
  });
});
